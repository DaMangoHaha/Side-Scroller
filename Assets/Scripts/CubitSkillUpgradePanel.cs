...
/// <summary>
/// Manages the Cubit Skill Upgrade UI panel.
...
/// </summary>
public class CubitSkillUpgradePanel : MonoBehaviour
{
    [Header("References")]
    public CubitPassive cubitPassive; // assign the player's CubitPassive component
    ...
    {
        "Tier 1: Protection Protocol's Cooldown -5 seconds",
        "Tier 2: Cubit's skill activates at 40% energy instead of 30%",
        "Tier 3: Protection Protocol pauses for 10 seconds instead of 5"
    };
    ...
    public void OpenPanel()
    {
        ...
        if (cubitPassive != null)
            currentTier = cubitPassive.GetUpgradeTier();

        // --- Dark overlay ---
        panelRoot = new GameObject("CubitUpgradePanel");
        ...
        titleTMP.text = "Protection Protocol Upgrades";
    ...
    {
        if (cubitPassive == null) return;

        int currentTier = cubitPassive.GetUpgradeTier();
        ...
        Debug.Log("Cubit Skill upgraded to Tier " + tierNumber + "!");
    ...
    private Canvas GetOrCreatePopupCanvas()
    {
        ...
        GameObject existing = GameObject.Find("CubitUpgradeCanvas");
        if (existing != null)
        {
        ...
        GameObject canvasGO = new GameObject("CubitUpgradeCanvas");
