...
public class Level5CutsceneOpening : MonoBehaviour
{
    ...
    // Prevent repeatedly attempting to load Level 5 every frame
    private bool level5Loaded = false;
    ...
    // Other systems (like Level5CutsceneSkip) can call this to avoid duplicate handling.
    ...
    private void Update()
    {
        ...
        // load the Level5 scene once (guarded by level5Loaded).
